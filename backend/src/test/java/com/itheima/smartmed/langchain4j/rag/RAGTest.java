...
public class RAGTest {
    ...
    public void testReadDocument() {
        ...
        String path = "src/main/resources/knowledge/test.txt";
    ...
    public void testTokenCount() {
        ...
        //HuggingFaceTokenizer openAiTokenizer = new OpenAiTokenizer(System.getenv("OPENAI_API_KEY"), "minimax-m2.5");
